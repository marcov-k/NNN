...
namespace NNNCSharp.Components.Utilities
{
    ...
    public static class IDManager
    {
        ...
        /// </summary>
        static readonly Type[] LayerIDs = new Type[] { typeof(Dense), typeof(Conv) };
        /// <summary>
        /// IDs for Activation subclasses.
        /// </summary>
        static readonly Type[] ActivationIDs = new Type[] { typeof(Linear), typeof(Sigmoid),
        ...
        public static byte GetLayerID(Layer layer) => (byte)Array.IndexOf(LayerIDs, layer.GetType());
        ...
        public static byte GetActivationID(Activation activation) => (byte)Array.IndexOf(ActivationIDs, activation.GetType());
