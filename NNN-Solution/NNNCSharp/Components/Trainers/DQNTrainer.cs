...
namespace NNNCSharp.Components.Trainers
{
    ...
    public class DQNTrainer
    {
        ...
        /// Agent being trained.
        /// </summary>
        public Model Agent { get; private set; }
        /// <summary>
        ...
        /// </summary>
        readonly DQNEnvironment Environment;
        /// <summary>
        ...
        int minRandomOpponentEpisodes = 200, double tau = 0.005, double maxGradNorm = 1.0, int minExperiences = 1000)
        {
            ...
            SelfPlay = environment is ISelfPlay;
            Optimizer = optimizer;
            Cost = cost;
            ...
            ReplayBuffer = new(replayBufferSize);
            BatchSize = batchSize;
            AgentBuffer = new(agentBufferSize);
