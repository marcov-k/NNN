...
namespace NNNCSharp.Components.Models
{
    ...
    public class Model : IDisposable
    {
        ...
        public List<Tensor> Parameters
        {
            get
            {
                _parameters ??= GetParameters().ToList(); // initialize internal property if not yet initialized
                return _parameters;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="inputFormat">Tensor representing the expected input format.</param>
        void SetUpLayers(Tensor inputFormat)
        {
        ...
        internal void ClipGradients(float maxNorm)
        {
