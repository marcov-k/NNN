...
namespace NNNCSharp.Components.DQNEnvironments
{
    ...
    public class TicTacToe : DQNEnvironment, ISelfPlay
    {
        ...
        public override Tensor StateFormat => new(new int[] { 1, 10 }); // encodes state of all 9 board positions + current player to move
        ...
        /// </summary>
        static readonly int[][] WinOrients = new int[][] { new int[] { 0, 1, 2 }, new int[] { 3, 4, 5 }, new int[] { 6, 7, 8 },
        new int[] { 0, 3, 6 }, new int[] { 1, 4, 7 }, new int[] { 2, 5, 8 }, new int[] { 0, 4, 8 }, new int[] { 2, 4, 6 } };
